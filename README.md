...
It reads the pin in `package.json`, downloads and verifies the requested version, saves it in a local cache, and runs it. This keeps npm, pnpm, Yarn, Bun, Deno, and aube versions consistent across developer machines and CI.
