import type {Filename, PortablePath}                 from './_fslib.ts';
import {ppath, xfs, npath}                           from './_fslib.ts';
import os                                            from 'node:os';
import process                                       from 'node:process';
import {afterEach, beforeEach, describe, expect, it} from 'vitest';

import { config } from './_compat.ts';
import * as folderUtils from './_compat-folders.ts';
import { SupportedPackageManagerSet } from './_compat.ts';
