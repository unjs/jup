...
jup reads the package manager declared in `package.json`, downloads and verifies that release, and runs it. It supports npm, pnpm, Yarn, aube, Bun, Deno, and nub.
