...
1. [Learn how project pins work](/docs/projects)
2. [Set up CI and offline builds](/docs/ci)
3. [Configure registries and authentication](/docs/registry)
4. [Read the command reference](/docs/commands)
