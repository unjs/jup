...
jup adds about **7 ms** when it runs a cached tool. It loads 170 kB of JavaScript (57 kB gzipped), and the published package is 203 kB.
...
::note
Install the standalone binary with `curl -fsSL https://jup.unjs.io/install.sh | sh`, or install from npm to get the shimmed tool commands. Follow the [Start guide](./start) for both, including Windows.
::
