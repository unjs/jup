...
Bun and Deno are pinned like any other package manager:
...
Bun and Deno are not shimmed by a bare `jup enable`; see [Getting started](./getting-started).
