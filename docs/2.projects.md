...
By default the digest goes in the version suffix. For a clean version plus a
separate digest, use:
...
This stores integrity in `devEngines.packageManager.integrity`. Both forms are
read the same way.
