...
```sh
JUP_NPM_REGISTRY=https://npm.example.com jup install
```
...
```sh
JUP_NPM_USERNAME=alice JUP_NPM_PASSWORD="$PASSWORD" jup install
```
...
```sh
JUP_CAFILE=/etc/company/roots.pem jup install
```
