...
Use `v0` for the latest v0 release. Use `v0.5` to stay on that minor line. Use a
full tag such as `v0.5.2` for a fixed action version. Before v1, a minor release
